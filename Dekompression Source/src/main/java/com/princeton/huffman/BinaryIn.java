 ...
 *  Compilation:  javac com.princeton.huffman.BinaryIn.java
 *  Execution:    java com.princeton.huffman.BinaryIn input output
 *  Dependencies: none             
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java com.princeton.huffman.BinaryIn https://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 ******************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code com.princeton.huffman.BinaryIn} with calls
...
public final class BinaryIn {
   ...
   /**
     * Unit tests the {@code com.princeton.huffman.BinaryIn} data type.
