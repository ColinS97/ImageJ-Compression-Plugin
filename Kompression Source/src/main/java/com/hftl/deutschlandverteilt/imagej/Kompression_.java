...
package com.hftl.deutschlandverteilt.imagej;

import com.princeton.huffman.Huffman;
import ij.IJ;
import ij.ImageJ;
import ij.ImagePlus;
...
if(!grey){
	...
	public void huffman_encoding(){
		...
		SaveDialog gd = new SaveDialog("Speichern unter...",bytefilepath,"rlchuf");
		//showMessage(gd.getDirectory());
		//showMessage(gd.getFileName());
