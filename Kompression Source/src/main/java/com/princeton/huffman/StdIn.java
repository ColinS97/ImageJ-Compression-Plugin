package com.princeton.huffman; /******************************************************************************
 *  Compilation:  javac com.princeton.huffman.StdIn.java
 *  Execution:    java com.princeton.huffman.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code com.princeton.huffman.StdIn} class provides static methods for reading strings
 ...
 *  <pre>
 *  while (!com.princeton.huffman.StdIn.isEmpty()) {
 *      double value = com.princeton.huffman.StdIn.readDouble();
 *      com.princeton.huffman.StdOut.println(value);
 *  }
 *  com.princeton.huffman.StdOut.println(sum);
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (com.princeton.huffman.StdIn.hasNextChar()) {
 *      char c = com.princeton.huffman.StdIn.readChar();
 *      com.princeton.huffman.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (com.princeton.huffman.StdIn.hasNextLine()) {
 *      String line = com.princeton.huffman.StdIn.readLine();
 *      com.princeton.huffman.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = com.princeton.huffman.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code com.princeton.huffman.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code com.princeton.huffman.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code com.princeton.huffman.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code com.princeton.huffman.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code com.princeton.huffman.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code com.princeton.huffman.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code com.princeton.huffman.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code com.princeton.huffman.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code com.princeton.huffman.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to com.princeton.huffman.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to com.princeton.huffman.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to com.princeton.huffman.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to com.princeton.huffman.StdIn
    
    
    // do this once when com.princeton.huffman.StdIn is initialized
    static {
        resync();
    }

    /**
     * If com.princeton.huffman.StdIn changes, use this to reinitialize the scanner.
     */
